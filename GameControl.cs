...
public class GameControl : MonoBehaviour {
    ...
    public void Log(float time)
    {
        ...
        Write(currentTrial, currentBlock, error, travelDistanceOptimal, counter);
        counter = 0;
    }
    ...
    public void InitGame()
    {
        ...
        {
            writer = new StreamWriter("Assets/Resources/" + "/ULPD_Screen_" + pID.text + ".txt", true);
    ...
    public void Write(int trial, int block, float err, float optDist, float t)
    {
        var timeMS = t * 1000;
    ...
    public void PracticeUpdate(bool first)
    {
        if (practiceBlock)
        {
            practiceText.text = "Practice Blocks: True";
